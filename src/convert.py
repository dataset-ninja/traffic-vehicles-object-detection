...
def convert_and_upload_supervisely_project(
    ...
    images_path = os.path.join("Traffic Dataset","images")

    bbox_path = os.path.join("Traffic Dataset","labels")
    ...
    number_plate = sly.ObjClass("number_plate", sly.Rectangle)
    blur_number_plate = sly.ObjClass("blur_number_plate", sly.Rectangle)
    wheeler = sly.ObjClass("two_wheeler", sly.Rectangle)
    ...
    for ds_name in os.listdir(images_path):
        ...
        curr_anns_path = os.path.join(bbox_path, ds_name)
